...
local Config = {
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/n0namevnnek-web/Ink-Game/refs/heads/main/Ink%20Game", -- The raw URL of your main script
    ...
    HubDescription  = "Ink Game Script" -- The text shown below the title
}
